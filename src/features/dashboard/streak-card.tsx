...
const WEEKS = 4;
const CELL_OPACITY = [0.1, 0.3, 0.5, 0.72, 1];
/** Dark ink on the #CFF400 lime card. */
const INK = '#141512';

/** The streak, with the last four weeks as a small heatmap: rows are weeks (oldest first), columns Mon→Sun. */
            ...
            {week.map((cell) => (
              <View
                ...
                style={[
                  ...
                  {
                    backgroundColor: INK,
                    opacity: cell.isFuture ? 0.04 : CELL_OPACITY[relativeLevel(activity?.total[cell.date] ?? 0, max)],
